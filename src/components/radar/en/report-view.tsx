...
export function EnglishReportView({ report }: { report: LoveReport & { id: string } }) {
  ...
  return (
    <main className="min-h-svh px-4 py-5 text-white"><div className="mx-auto w-full max-w-3xl space-y-5">
      <div className="flex items-center justify-between"><Link href="/en" className="inline-flex items-center gap-2 text-sm text-muted-foreground"><ArrowLeft className="h-4 w-4" />Love Radar AI</Link><Link href="/en/me" className="text-sm text-primary">My account</Link></div>
